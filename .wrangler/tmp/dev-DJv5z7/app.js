...
// .wrangler/tmp/bundle-v9rtEF/strip-cf-connecting-ip-header.js
...
var app = new Hono2();
app.use("/*", cors());
var getJwtSecret = /* @__PURE__ */ __name((c) => c.env.JWT_SECRET || "default-secret-change-me", "getJwtSecret");
...
var authMiddleware = /* @__PURE__ */ __name(async (c, next) => {
  ...
  try {
    const payload = await verify2(token, getJwtSecret(c));
    c.set("user", payload);
    await next();
  } catch (error) {
...
// .wrangler/tmp/bundle-v9rtEF/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-v9rtEF/middleware-loader.entry.ts
